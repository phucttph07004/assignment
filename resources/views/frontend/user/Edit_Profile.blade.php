				...
				<div class="tile-body">
					<div class="col-md-10">
						...
						<div style="margin-top: 100px;margin-left:100px" class="card card-primary">
						  ...
						  <!-- /.card-header -->
						  <!-- form start -->
						  <form method="POST" action="{{ route('userprofile.update',Auth::user()->id) }}" role="form">
							  @csrf
							  @method('PUT')
							<div class="card-body">
							  ...
							  <div class="form-group">
								...
								<input type="number" name="phone" value="{{ $user->phone }}" class="form-control" id="exampleInputPassword1" >
							  </div>
							  <div class="form-group">
